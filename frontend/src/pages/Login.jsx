    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{backgroundColor: '#020617'}}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="inline-flex h-14 w-14 md:h-16 md:w-16 items-center justify-center rounded-2xl backdrop-blur-xl mb-3 md:mb-4" style={{background: 'rgba(124, 58, 237, 0.15)', border: '1px solid rgba(124, 58, 237, 0.3)'}}>
            <svg className="w-8 h-8 md:w-9 md:h-9" style={{color: '#7c3aed'}} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
            </svg>
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-white">TicketSense</h1>
          <p className="text-xs md:text-sm mt-2" style={{color: '#cbd5e1'}}>4D & TOTO Dashboard</p>
        </div>

        {/* Login Card with Glassmorphism */}
        <div className="rounded-2xl shadow-2xl p-6 md:p-8 backdrop-blur-xl" style={{background: 'rgba(15, 23, 42, 0.7)', border: '1px solid #1e293b', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)'}}>
